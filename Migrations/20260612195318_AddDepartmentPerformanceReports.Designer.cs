...
namespace Personelim.Migrations
{
    ...
    [Migration("20260612195318_AddDepartmentPerformanceReports")]
    partial class AddDepartmentPerformanceReports
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Personelim.Models.ChatConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Personelim.Models.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("IslemYapildi")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("Personelim.Models.DepartmentPerformanceReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<double>("DepartmanSkoru")
                        .HasColumnType("double precision");
                    ...
                    b.HasIndex("BusinessId", "DepartmentId", "PeriodEnd");

                    b.ToTable("DepartmentPerformanceReports");
                });
            ...
            modelBuilder.Entity("Personelim.Models.Schedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Personelim.Models.Shift", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Personelim.Models.SlackWebhook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SlackWebhooks");
                });

            modelBuilder.Entity("Personelim.Models.TaskItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Personelim.Models.ChatMessage", b =>
                {
                    b.HasOne("Personelim.Models.ChatConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Personelim.Models.Schedule", b =>
                {
                    ...
                    b.HasOne("Personelim.Models.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Personelim.Models.TaskItem", b =>
                {
                    b.HasOne("Personelim.Models.User", "AssignedByUser")
                        .WithMany()
                        .HasForeignKey("AssignedByUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Personelim.Models.User", "AssignedToUser")
                        .WithMany()
